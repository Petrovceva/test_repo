...
@pytest.mark.usefixtures('make_folders', 'make_files', 'delete_folders', 'print_time', 'stat')
class TestSeminar:
    ...
    def test_step_2(self):
        assert check_command(f"cd {data.get('folder_out')}; 7z rn archive_1 file_1.txt file_2.txt file_3.txt", 'Everything is OK')
