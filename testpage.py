...
class OperationsHelper(BasePage):
    ...
    def enter_contact_content(self, word):
        self.enter_text_info_field(TestSearchLocators.ids['LOCATOR_CONTACT_CONTENT_FIELD'], word, description='contact content')
    ...
    def click_contact_send_btn(self):
        self.click_button(TestSearchLocators.ids['LOCATOR_CONTACT_SEND'], description='contact')
    ...
    def get_text_from_element(self, locator, description=None):
        ...
        try:
            ...
            logging.exception(f'Exceptionwhile get test from {element_name}')
            return None
    ...
    def get_user_text(self):
        return self.get_text_from_element(TestSearchLocators.ids['LOCATOR_HELLO'], description='hello text')
   
    def get_res_text(self):
        return self.get_text_from_element(TestSearchLocators.ids['LOCATOR_RES_LBL'], description='res text')
